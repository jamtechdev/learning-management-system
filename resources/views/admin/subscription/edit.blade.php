            ...
            <div class="row">
                <div class="mx-auto col-md-6">
                    ...
                    <div class="overflow-hidden bg-white border border-gray-100 rounded-lg shadow-lg">
                        <div class="p-6">
                            <form method="POST" action="{{ route('admin.subscriptions.update', $plan->id) }}" class="space-y-6">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="w-full">
                                    ...
                                    <select name="duration_days" id="duration"
                                        ...
                                        required>
                                        <option value="7" {{ old('duration_days', $plan->duration_days) == '7' ? 'selected' : '' }}>
                                            🗓️ 1 Week (7 days)
                                        </option>
                                        <option value="30" {{ old('duration_days', $plan->duration_days) == '30' ? 'selected' : '' }}>
                                            📅 1 Month (30 days)
                                        </option>
                                        <option value="365" {{ old('duration_days', $plan->duration_days) == '365' ? 'selected' : '' }}>
                                            🎯 1 Year (365 days)
                                        </option>
                                    </select>
                                    @error('duration_days')
                                ...
                                <div class="flex gap-3 pt-4">
                                    ...
                                    <button type="submit"
                                        class="flex-1 px-3 py-2 text-sm font-medium text-white transition-all duration-200 rounded-lg shadow-md bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 hover:shadow-lg">
                                        <span class="flex items-center justify-center">
                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
