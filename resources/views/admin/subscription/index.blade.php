                            ...
                            @forelse ($plans as $plan)
                                <tr class="hover:bg-gray-50">
                                        ...
                                        @if ($plan->subjects->count())
                                            <div class="flex flex-wrap gap-1">
                                                @foreach ($plan->subjects as $subject)
                                                    <span
                                                        class="inline-block px-2 py-0.5 text-xs font-semibold text-white bg-indigo-600 rounded">
                                                        {{ $subject->name }}
                                                    </span>
                                                @endforeach
                                            </div>
                                    ...
                                    <td class="px-6 py-4 space-x-2 text-sm font-medium text-center whitespace-nowrap">
                                        ...
                                        <form action="{{ route('admin.subscriptions.destroy', $plan->id) }}"
