                ...
                <div>
                    ...
                    @foreach ($pairs as $i => $pair)
                        <div class="p-4 mb-6 border border-yellow-300 rounded-lg bg-yellow-50">
                            ...
                            {{-- Left (Label) --}}
                            <div class="mb-4">
                                <label class="block font-semibold text-yellow-700">Left Side (Label)</label>
                                ...
                                @else
                                    <input type="text"
                                        ...
                                        class="w-full p-2 border border-yellow-300 rounded-lg focus:ring-yellow-200">
                                    <input type="hidden"
                            ...
                            {{-- Right (Value) --}}
                            <div class="mb-4">
                                <label class="block font-semibold text-yellow-700">Right Side (Value)</label>
