                        ...
                        <tr>
                            ...
                            <td class="max-w-md px-4 py-3 overflow-y-auto text-gray-900 dark:text-gray-100">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="p-2 border rounded bg-gray-50 dark:bg-gray-800 flex gap-[10px] items-center">
                                        <div class="font-semibold text-gray-700 dark:text-gray-300">
                                            Blank #{{ $blank['blank_number'] }} :
                                        </div>
                                        <ul class="pl-5 mt-1 list-disc list-inside text-gray-600 dark:text-gray-400 mt-0 pl-0">
