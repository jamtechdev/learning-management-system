                                        ...
                                        @case(\App\Enum\QuestionTypes::FILL_IN_THE_BLANK)
                                            <div class="space-y-4">
                                                @foreach ($question->metadata['blanks'] ?? [] as $blank)
                                                    <div
                                                        class="p-2 border rounded bg-gray-50 dark:bg-gray-800 flex gap-[10px] items-center">
                                                        <div class="font-semibold text-gray-700 dark:text-gray-300">
                                                            Blank #{{ $blank['blank_number'] }} :
                                                        </div>
                                                        <ul
                                                            class="pl-0 pl-5 mt-0 mt-1 text-gray-600 list-disc list-inside dark:text-gray-400">
