                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium leading-5 text-white bg-blue-600 border border-blue-600 rounded-md cursor-default dark:bg-blue-500 dark:border-blue-500">
                                            {{ $page }}
                                        </span>
                                    </span>
                                @else
