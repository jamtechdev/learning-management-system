        ...
        <ul class="space-y-3 text-sm font-medium text-gray-700 dark:text-gray-300">
            ...
            <li>
                <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="flex-shrink-0 w-6 h-6 text-indigo-600 dark:text-indigo-400" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M3 12l2-2m0 0l7-7 7 7m-9 2v6m0 0h-4a2 2 0 01-2-2v-2m14 0v2a2 2 0 01-2 2h-4m0-6v-6" />
                    </svg>
                    <span>Dashboard</span>
                </x-nav-link>
            </li>
            ...
            <li>
                <button @click="open = !open" :aria-expanded="open.toString()" aria-controls="submenu-questions"
                    ...
                    <span class="flex-1 font-semibold text-left text-indigo-600 dark:text-indigo-400">Question
                        Management</span>
                ...
                <div id="submenu-questions" x-show="open" x-collapse
                    class="mt-3 space-y-1 border-l border-indigo-300 dark:border-indigo-700" style="display: none;">
                    <ul>
                        <li>
                            <x-nav-link :href="route('admin.levels.index')" :active="request()->routeIs('admin.levels.*')"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="flex-shrink-0 w-5 h-5 text-indigo-600 dark:text-indigo-400" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <li>
                <x-nav-link href="{{ route('admin.parents.index') }}" :active="request()->routeIs('admin.parents.*')"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M18 9a3 3 0 11-6 0 3 3 0 016 0zM6 9a3 3 0 11-6 0 3 3 0 016 0zM3 15h6m6 0h6" />
                    </svg>
