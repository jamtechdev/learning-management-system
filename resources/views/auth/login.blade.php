<x-guest-layout>
    ...
    <div class="mb-[30px]">
        <h1 class="mb-2 text-3xl font-bold text-left text-gray-950">
         Welcome to Back! 👋

        </h1>
        <p class="mt-0 text-left text-gray-500 text-md">Please sign in to your account and start the adventure</p>
    </div>
